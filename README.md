...
The goal is to show real-world SOC engineering practices using automation, state management, and security-first design.

This project simulates how security engineers build and manage cloud security infrastructure in production environments.

---

## 🛠️ Tools & Technologies Used

- **Terraform (HCL)** – Infrastructure-as-Code provisioning  
- **PowerShell** – Command-line execution environment  
- **Microsoft Azure** – Cloud platform  
- **Microsoft Sentinel** – Cloud-native SIEM  
- **Log Analytics Workspace** – Centralized security logging  
- **Azure Storage Account** – Secure storage for logs/artifacts  
- **Azure Resource Groups** – Infrastructure organization  
- **Terraform State Management** – Infrastructure tracking & locking  

---

## 🚀 Features

- Automated deployment of SOC infrastructure using Terraform  
- Microsoft Sentinel enabled via code  
- Secure Log Analytics Workspace creation  
- Secure Storage Account provisioning  
- Terraform state tracking and locking  
- Enterprise-grade IaC workflow validation  
- Reproducible and auditable security infrastructure  

---

## 💻 Command Line, Scripting & Infrastructure-as-Code

This lab was built and validated using:

- **PowerShell** as the execution shell  
- **Terraform (HCL – HashiCorp Configuration Language)** as the coding language  

No Python or Linux shell was used. All automation was done with PowerShell + Terraform.
...
- Demonstrate enterprise-grade IaC workflows  
...
terraform state show azurerm_storage_account.security_storage
terraform state show azurerm_sentinel_log_analytics_workspace_onboarding.sentinel
